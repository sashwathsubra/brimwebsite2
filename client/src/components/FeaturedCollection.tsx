...
const collections: ProductItem[] = [
  {
    ...
    features: [
      "Night time readable, suits upto 250 sq. ft. rooms. ",
      "Ideal for homes, offices, and executive cabins. ",
      "Highly Bright 7-segment digital LED clock display.",
      ...
      "1-year guarantee, Buy directly from the manufacturer in Chennai. ",
    ],
  ...
  },
  {
    ...
    features: [
      "Night time readable, suits upto 400 sq. ft. rooms. ",
      "Ideal for banks, shops, homes and showrooms. ",
      "High-bright 7x30 LED dot matrix clock featuring user-selectable dual font options. ",
      "Durable for 8+ years with a built-in lithium battery for memory backup (5V DC power supply included). ",
      "Constructed with an aluminium powder-coated finish. ",
      "1-year guarantee, Buy directly from the manufacturer in Chennai. ",
    ],
  ...
  },
  {
    ...
    features: [
      "Night time readable, suits upto 300 sq. ft. rooms. ",
      "The ideal digital calendar clock for hotels, homes, offices and schools. ",
      "High-bright 14x56 LED dot matrix display shows the time, day, and date clearly at a glance.",
      "8+ years of durability, maintenance-free operation with a built-in lithium battery memory backup.",
      "Constructed with an aluminium powder-coated finish. ",
      "1-year guarantee. Order your digital clocks today (5V DC power supply included).",
    ],
    size: "Size: 26 x 8 x 4 cm | Weight: 450g",
  },
  {
    ...
    hasTriColor: true,
    features: [
      "Night time readable, suits upto 2000 sq. ft. rooms. ",
      ...
      "An aluminium powder-coated finish with a built-in lithium battery for 8+ years of maintenance-free operation.",
      "1-year guarantee, Buy the best digital clocks in Chennai (5V DC power supply included).",
    ],
  ...
  },
  {
    ...
    category: "Industrial Clocks",
    features: [
      "Bright 5mm LEDs provide perfect night-time readability and long-distance day visibility.",
      "Jumbo LED clock for factories, warehouses, temples, chruches and mosques (Suits 5000+ sq. ft. halls).",
      "Heavy-duty aluminium powder-coated finish designed for wall or ceiling mounting.",
      "Operates on 12V DC (power supply included) with a built-in lithium battery for continuous memory backup.",
      "1-year guarantee with 8+ years of maintenance-free durability. Trusted across India.",
    ],
