...
const collections: ProductItem[] = [
  {
    ...
    features: [
      "Night time readable: Designed for clear visibility in dim and brightly lit environments. ",
      ...
      "Complete Kit: Includes a 5V DC power supply, setting buttons, and an ABS plastic finish. Order your digital clock online today.",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "High Brightness: Features a premium 7-segment digital LED clock display.",
      "Maintenance-Free: Offers an 8+ year durable lifespan with a built-in lithium battery for memory backup.",
      "Complete Kit: Includes a 5V DC power supply, setting buttons, and an ABS plastic finish. Buy the top-rated LED clock in Chennai.",
    ],
    size: "Size: 14 x 6.5 x 3 cm | Weight: 250g",
  },
  {
  ...
  },
  {
    ...
    category: "Industrial Clocks",
    features: [
      "Maximum Visibility: Ultra-bright 5mm LEDs provide perfect night-time readability and long-distance day visibility.",
