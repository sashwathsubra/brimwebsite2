...
const collections: ProductItem[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "The ideal digital calendar clock for homes, Shops, offices and Executive cabin. ",
      "High-bright 14x56 LED dot matrix display shows the time, day, and date clearly at a glance.",
      "8+ years of durability, maintenance-free with a built-in lithium battery memory backup.",
      "Aluminium powder-coated finish. ",
      "1-year guarantee.(5V DC power supply included).",
    ],
    size: "Size: 26 x 8 x 4 cm | Weight: 450g",
  },
  {
    ...
    features: [
      ...
      "Aluminium powder-coated finish with a built-in lithium battery for 8+ years of maintenance-free operation.",
      "1-year guarantee.(5V DC power supply included).",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Jumbo LED clock for Schools, Colleges, factories, warehouses, temples, chruches and mosques (Suits 5000+ sq. ft. halls).",
      ...
      "1-year guarantee with 8+ years of maintenance-free durability.",
    ],
